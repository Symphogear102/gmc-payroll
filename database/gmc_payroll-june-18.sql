...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2022 at 09:12 AM
...
(50, 'test', 'a', 'Torres', '09151234567', '196 Osmeña Street', 'Male', '2022-05-05', 'test@gmail.com', '2022-05-13', 3, 20000.00, 'GMC-0001', 'active', 0x494d472d36323764623130353137616430302e38353635363832312e6a7067),
...
(57, 'Angelico Guiller', 'G', 'Talag', '09123123123', 'Paco, Obando, Bulacan', 'Male', '1999-09-19', 'guiller@gmail.com', '2022-05-28', 4, 20000.00, 'GMC-0002', 'active', 0x494d472d36323931653761666431633336382e31383631343737312e6a7067);
...
(44, 'admin   ', '$2y$10$gnO9MbEg2E9AQl5Xnkho4u6.MN9rrVC7.9SBcA9agknt9jjboE91y', 3, '2022-05-13'),
(45, 'GMC-0001', '$2y$10$KPXZ3Df06/NtkroLjRKMP.SgcRSBoxE4eutHn6bjUNAzwtJTl9Oxy', 1, '2022-05-13'),
(52, 'GMC-0002', '$2y$10$tKkwvWh0SPMfwTbN9pdBl.jdMPcKlB54yLBToXeZht.maWvXKozD6', 1, '2022-05-28');
...
--
ALTER TABLE `userinfo`
  MODIFY `userInfoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `userlogin`
--
ALTER TABLE `userlogin`
  MODIFY `userLoginID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
